...
import controle.controleTelaCadastrar.SalvarFichaFuncional;


public class FichaFuncional extends JDesktopPane implements ControleComponentes{
	...
	public FichaFuncional() {
		...
		btnSalvar.addActionListener(new SalvarFichaFuncional(this));
		add(btnSalvar);
