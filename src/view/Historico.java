...
import controle.controleTelaCadastrar.DeletarFerias;
import controle.controleTelaCadastrar.DeletarLicenca;
import controle.controleTelaCadastrar.DeletarVidaFuncional;
import controle.controleTelaCadastrar.ListarTipoLicencas;
import controle.controleTelaCadastrar.SalvarFerias;
import controle.controleTelaCadastrar.SalvarLicenca;
import controle.controleTelaCadastrar.SalvarVidaFuncional;
...
public class Historico extends JDesktopPane implements ActionListener, ControleComponentes{
	...
	private void carregar_componentes(){
		...
		salvar_1.addActionListener(new SalvarVidaFuncional(this));
		this.add(salvar_1);
		
		deletar_1 = new JButton("Deletar");
		deletar_1.setBounds(867, 70, 100, 30);
		deletar_1.addActionListener(new DeletarVidaFuncional());
		this.add(deletar_1);
		...
		comboBox = new JComboBox<String>(ListarTipoLicencas.preencherComboBox());
		...
		salvar_2.addActionListener(new SalvarLicenca(this));
		this.add(salvar_2);
		
		deletar_2 = new JButton("Deletar");
		deletar_2.setBounds(867, 391, 100, 30);
		deletar_2.addActionListener(new DeletarLicenca());
		this.add(deletar_2);
		...
		salvar_3.addActionListener(new SalvarFerias(this));
		this.add(salvar_3);
		
		deletar_3 = new JButton("Deletar");
		deletar_3.setBounds(867, 660, 100, 30);
		deletar_3.addActionListener(new DeletarFerias());
		this.add(deletar_3);
