...
//				new EditarFuncionario(tela).construirTabelaComHistorico();
				
				pane.removeAll();
//				pane.add(tela);
				pane.add(new Consultar(Aplicacao.this));
//				new EditarFuncionario((Consultar) pane.getComponent(pane.getComponentCount()-1)).construirTabelaComHistorico();
				pane.repaint();
